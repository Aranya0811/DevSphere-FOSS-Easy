...
* Each of the next $t$ lines contains two integers $n$ and $k$ ($2 \le n \le 10^9$, $1 \le k \le 10^9$).
...
2. Ensure it can pass our automated CI Agent checks (which include hidden performance tests).
3. Submit a Pull Request with the correct, working version.
